declare interface IMeetingAppWebPartStrings {
  ...
  AdminSettingGroupContributers:string;
  AdminSettingGroupAdministrators:string;
  PreviousLabel: string;
  NextLabel: string;
...
declare module 'MeetingAppWebPartStrings' {
  const strings: IMeetingAppWebPartStrings;
  export = strings;
}
